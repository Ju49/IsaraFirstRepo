...
Cette séquence nous a permis de découvrir et de mettre en pratique la notion de machine learning. Le fait de savoir comment fonctionne un corpus d'apprentissage permet, entre autres, d'utiliser les applications mobiles de reconnaissance d'images en comprennant comment ces dernières fonctionnent et non plus comme des consommateur·trice·s "naïfs·naïves".
